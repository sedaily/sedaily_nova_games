...
export function ProgressRippleIndicator({ current, total, score, progress }: ProgressRippleIndicatorProps) {
  return (
    <div className="sticky top-0 z-50 bg-gradient-to-r from-[#0c4a6e] to-[#0891b2] text-white py-4 px-6 shadow-lg">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="h-2 bg-white/20 rounded-full overflow-hidden relative">
          <motion.div
            className="h-full bg-gradient-to-r from-white to-[#e0f2fe] relative"
            initial={{ width: 0 }}
