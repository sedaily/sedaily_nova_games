    ...
    <div className="max-w-2xl mx-auto">
      <Card className="p-8 bg-gradient-to-br from-[#e0f2fe] to-white border-2 border-[#0891b2]/30">
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="flex items-start gap-4 p-4 bg-white rounded-lg">
            <div className="w-10 h-10 rounded-full bg-[#0c4a6e]/10 flex items-center justify-center flex-shrink-0">
        ...
        <Button
          onClick={onStart}
          className="w-full py-6 text-lg font-semibold korean-text bg-gradient-to-r from-[#0891b2] to-[#2563eb] hover:opacity-90 transition-opacity"
          aria-label="퀴즈 시작하기"
        >
          퀴즈 시작하기 🦢
        </Button>
